               ...
               <div class="row">
                  ...
                  <div class="col-md-3 col-sm-3 pull-right">
                     <div class="seipkon-breadcromb-right">
                        ...
                        <a style="margin-right: 5px;" href="<?php echo site_url('Masters/add_test_category')?>" class="btn btn-info btn-vsm"><i class="fa fa-plus"></i> Add</a>
                       ...
                       <tbody>
                        <?php
                            ...
                            foreach($all_value as $value){
                                $edit_link= site_url('Masters/edit_test_category?edid=').$value->id;
                            ?>   
                               <tr>
                                 <td><?php echo $i;?></td>
