 <script type="text/javascript">$(document).ready(function(e){
  ...
  $.ajax({
    type: "POST",
    url: "<?php echo site_url('Masters/insert_consultant_category'); ?>",
    data: formData,
    processData: false,
    contentType: false,
    dataType: "JSON", 
    success: function(data) {
      if(data.status=='success'){
        ...
        setTimeout(function(){
          window.location = "<?php echo site_url('Masters/consultant_category'); ?>"; 
        },1000);
...
$("form#frm-update-data").submit(function(e) { e.preventDefault();
  ...
  $.ajax({
    type: "POST",
    url: "<?php echo site_url('Masters/update_consultant_category'); ?>",
    data: formData,
    processData: false,
    contentType: false,
    dataType: "JSON", 
...
$("#custom_tbl").on("click",".delete-data",function(){ 
  ...
  swal({
    ...
    if (willDelete) {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo site_url('Masters/delete_consultant_category'); ?>",
